<section class="features11 cid-rgqVBO4rv6 mt-5" id="features11-19">
    <div class="container">
        <h2 class="mbr-title mbr-fonts-style display-5">STORIES</h2>
        <!--start-->
        <div class="row">
            <div class="col-md-9">
            <?php foreach($result as $row): ?>
                    ...
                    <div class="media-container-row pb-5">
                        <div class="mbr-figure" style="width: 40%;">
                            <a href="<?php echo base_url();?>healthful/latest/read-more/<?=$row->uri_title;?>"><img src="<?php echo base_url();?>assets_healthful/images/<?=$row->thumbnail?>" alt="" title=""></a>
                        </div>
                        <div class="align-left aside-content">
                            <h2 class="mbr-title pt-2 mbr-fonts-style display-5"><a href="<?php echo base_url();?>healthful/latest/read-more/<?=$row->uri_title;?>"><?=$row->title?></a></h2>
                                ...
                                <div class="card">
                                    <div class="card-box">
                                        <p class="block-text mbr-fonts-style display-7">
                                            ...
                                            ?>
                                            <span class="badge"><a href="<?php echo base_url();?>healthful/latest/read-more/<?=$row->uri_title;?>">Read More</a></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container">
                    <?php 
                        if(strlen($pagination)): echo $pagination; endif; 
                    ?> 
                </div>
            </div>
            <!--end-->
