...
class Medical_team extends CI_Controller {
	...
	function our_doctors(){
		...
		$data['main'] = 'medical/ourdoctors';
		$data['records'] = $this->medical_model->doctors_list();
		$this->settings($data);
	}
	...
	function profile(){
        ...
        $data['records'] = $this->medical_model->profile($uri);
        $data['schedule'] = $this->medical_model->schedule($uri);
		$data['main'] = 'medical/doctorsprofile';
        $this->settings($data);
    }
