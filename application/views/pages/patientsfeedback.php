    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            ?>
                    ...
                    <?php echo form_open('patients_feedback/sendMail','class="mbr-form"'); ?>
                        ...
                        <div class="row row-sm-offset">
                            ...
                            <div class="col-md-4 multi-horizontal" data-for="subject">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="Patients Feedback" name="subject" data-form-field="Subject" required="" id="subject">
                                </div>
                            </div>
                        </div>
