...
else{if($(document).find('section.section-table').length!=0){$('section.section-table').each(function(){var isSearch=$(this).find('table').is('.isSearch');if(isSearch){var infoBefore=$(this).find('.dataTables_info span.infoBefore').text(),infoAfter=$(this).find('.dataTables_info span.infoAfter').text(),infoFilteredBefore=$(this).find('.dataTables_info span.infoFilteredBefore').text(),infoFilteredAfter=$(this).find('.dataTables_info span.infoFilteredAfter').text();searchText=$(this).find('.dataTables_filter label.searchInfo').text(),infoClasses=$(this).find('.dataTables_info').attr('class').split(/\s/),searchClasses=$(this).find('.dataTables_filter label.searchInfo').attr('class').split(/\s/),displayInfoFont=getDisplayClass(infoClasses),displayFilterFont=getDisplayClass(searchClasses),searchInput=$(this).find('.dataTables_filter input').attr('class').split(/\s/);$(this).find('.row.search').remove();$(this).find('.table-wrapper .scroll').removeClass('scroll');$(this).find('.row.info').remove();initTable($(this),isSearch,searchText,infoBefore,infoAfter,infoFilteredBefore,infoFilteredAfter);$(this).find('.dataTables_info').addClass(displayInfoFont);$(this).find('.dataTables_filter label').addClass(displayFilterFont);searchInput.forEach(function(el){$(this).find('.dataTables_filter input').addClass(el);},$(this));}else{$(this).find('.row.search').remove();$(this).find('.table-wrapper .scroll').removeClass('scroll');$(this).find('.row.info').remove();initTable($(this),isSearch);}});}}