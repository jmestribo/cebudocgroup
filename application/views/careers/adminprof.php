    ...
    <div class="container-fluid">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-1">Administrative Professionals</h2>
            </div>
        </div>
    </div>
</section>
            ...
            <div>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="CDUH">
                        <br />
                        <h4>CEBU DOCTORS' UNIVERSITY HOSPITAL</h4>
                        ...
                        <div class="alert alert-info">
                            ...
                            <br />
                            For inquiries kindly contact Nicole through this number<br />
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="SCDH">
                        <br />
                        <h4>SAN CARLOS DOCTORS HOSPITAL</h4>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="NGH">
                        ...
                        <div class="media-container-row pb-5">
                            <div class="mbr-figure" style="width: 40%; box-shadow: 5px 8px 2px 0px gray">
                                <img src="<?php echo base_url(); ?>assets/images/ngh_careers/administrative020619.jpg">
                            </div>
                        </div>
