    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                  <a href="<?php echo base_url();?>healthful"><img src="<?php echo base_url();?>assets_healthful/images/hfasset-6-574x170.png" alt="healthful" title="healthful" style="height: 5.3rem;"></a>
                </span>
            </div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
              <li class="nav-item">
                <a class="nav-link link text-white display-4" href="<?php echo base_url();?>healthful">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link link text-white display-4" href="<?php echo base_url();?>healthful/stories">Stories</a>
              </li>
              <li class="nav-item">
                <a class="nav-link link text-white display-4" href="<?php echo base_url();?>healthful/profiles">Profiles</a>
              </li>
              <li class="nav-item">
                <a class="nav-link link text-white display-4" href="#">Updates</a>
              </li>
              <li class="nav-item">
                <a class="nav-link link text-white display-4" href="<?php echo base_url();?>healthful/community">Community</a>
              </li>
              <li class="nav-item">
        ...
        <script type="text/javascript">
            function ajaxSearch()
            {
                ...
                else
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>healthful/autocomplete/",
                        data: post_data,
